...
CWM_UPDOWNDEL_UPLOAD_WEIGHT = int(os.getenv("CWM_UPDOWNDEL_UPLOAD_WEIGHT", "10"))
CWM_UPDOWNDEL_DOWNLOAD_WEIGHT = int(os.getenv("CWM_UPDOWNDEL_DOWNLOAD_WEIGHT", "100"))
...
CWM_UPDOWNDEL_MIN_FILES_PER_BUCKET = int(os.getenv("CWM_UPDOWNDEL_MIN_FILES_PER_BUCKET", "2"))
